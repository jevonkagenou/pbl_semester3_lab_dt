                    ...
                    <form action="<?= BASE_URL ?>/editor/berita/store" method="POST" enctype="multipart/form-data">
                        <div class="modal-body pt-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="jurnalis" class="form-select form-select-lg fs-6"
                                        style="border-radius: 10px;" required>
                        ...
                        <div class="modal-footer border-0 pt-0 pb-4 pe-4">
                            ...
                            <button type="submit" class="btn btn-primary fw-bold px-4"
                                style="border-radius: 10px; background: #435ebe; border:none;">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <form action="<?= BASE_URL ?>/editor/berita/update" method="POST" enctype="multipart/form-data">
                        <div class="modal-body pt-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Jurnalis</label>
                                    <select name="jurnalis" id="edit_jurnalis" class="form-select form-select-lg fs-6"
                                        style="border-radius: 10px;" required>
                                        <option value="">Pilih Jurnalis</option>
                                        <?php if(isset($members)): foreach($members as $m): ?>
                                        <option value="<?= $m['idmember'] ?>"><?= htmlspecialchars($m['namamember']) ?>
                        ...
                        <div class="modal-footer border-0 pt-0 pb-4 pe-4">
                            <button type="button" class="btn btn-light text-muted fw-bold" style="border-radius: 10px;"
                                data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn btn-primary fw-bold px-4"
                                style="border-radius: 10px; background: #435ebe; border:none;">Update</button>
                        </div>
                    </form>
                </div>
            </div>
