...
<head>
    ...
    <style>
        ...
        .table-modern thead th {
            ...
            font-size: 0.8rem; letter-spacing: 0.5px; padding: 15px 20px;
        }
        ...
        .btn-futuristic {
            background: linear-gradient(135deg, #435ebe 0%, #7c3aed 100%);
            border: none; border-radius: 12px; padding: 10px 24px; color: white;
            font-weight: 700; box-shadow: 0 5px 15px rgba(139, 92, 246, 0.3); transition: all 0.3s ease;
        }
        ...
        .btn-trigger-glass {
            background: rgba(254, 226, 226, 0.5); border: 1px solid #fecaca; color: #ef4444;
            ...
            gap: 6px; box-shadow: 0 4px 10px rgba(239, 68, 68, 0.1);
        }
        .btn-trigger-glass:hover {
            background: #ef4444; color: white; transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(239, 68, 68, 0.3); border-color: #ef4444;
        }
        ...
        .modal-glass .modal-content {
            background: rgba(20, 20, 20, 0.85); backdrop-filter: blur(15px); -webkit-backdrop-filter: blur(15px);
        ...
        .popover-glass-danger {
            ...
            border-radius: 12px !important; font-family: 'Nunito', sans-serif; max-width: 300px;
        }
        ...
        .popover-glass-danger .popover-header {
            background: transparent !important; border-bottom: 1px dashed #fecaca !important;
            color: #ef4444 !important; font-weight: 800 !important; font-size: 0.75rem !important;
            text-transform: uppercase !important; letter-spacing: 0.5px; padding: 12px 16px 8px 16px !important;
        }
