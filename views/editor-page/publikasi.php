...
<head>
    ...
    <style>
        ...
        .popover-glass-danger {
            ...
            box-shadow: 0 15px 35px -5px rgba(239, 68, 68, 0.25) !important;
            border-radius: 12px !important;
            font-family: 'Nunito', sans-serif;
            max-width: 300px;
        }

        .popover-glass-danger .popover-arrow::after {
            border-top-color: #ef4444 !important;
        }

        .popover-glass-danger .popover-arrow::before {
            border-top-color: #ef4444 !important;
        }

        .popover-glass-danger .popover-header {
        ...
        .popover-glass-danger .popover-body {
                            ...
                            <div class="d-flex justify-content-between align-items-center position-relative"
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 text-white-50 small">
                                        <span class="me-3"><i class="bi bi-check-circle-fill me-1"></i> Diterima:
                                            <?= isset($stats['terima']) ? $stats['terima'] : 0 ?></span>
                                        <span class="me-3"><i class="bi bi-x-circle-fill me-1"></i> Ditolak:
                                            <?= isset($stats['tolak']) ? $stats['tolak'] : 0 ?></span>
                                        <span><i class="bi bi-hourglass-split me-1"></i> Pending:
                                            <?= isset($stats['pending']) ? $stats['pending'] : 0 ?></span>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="icon-wrapper d-flex align-items-center justify-content-center me-3 flex-shrink-0"
                                                    ...
                                                    <i class="bi bi-file-earmark-text-fill text-primary d-flex align-items-center justify-content-center"
                                                        style="font-size: 24px; line-height: 1; width: 100%; height: 100%; margin: 0; padding: 0;">
                                                    </i>
                                                </div>
                                                <div>
                                                    <div class="fw-bold text-dark mb-1"
                                                        style="font-size: 1rem; max-width: 300px; line-height: 1.2;">
                                        ...
                                        <td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a href="<?= htmlspecialchars($row['linkfile'] ?? '#') ?>"
                                                        target="_blank" class="action-btn btn-link-modern"
                                                        title="Buka Link">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Judul
                                        Publikasi</label>
                                    <input type="text" name="judulpublikasi" class="form-control form-control-lg fs-6"
                                        style="border-radius: 10px;" required
                                        placeholder="Contoh: Analisis Big Data...">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Tahun
                                        Terbit</label>
                                    <input type="number" name="tahunterbit" class="form-control form-control-lg fs-6"
                                        style="border-radius: 10px;" required placeholder="2024">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Link
                                        Eksternal</label>
                                    <input type="url" name="linkfile" class="form-control form-control-lg fs-6"
                                        style="border-radius: 10px;" required placeholder="https://jurnal...">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Penulis</label>
                                    <select name="penulis" class="form-select form-select-lg fs-6"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="ringkasan" class="form-control form-control-lg fs-6"
                                        style="border-radius: 10px;" rows="3"
                                        placeholder="Deskripsi singkat publikasi..."></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer border-0 pt-0 pb-4 pe-4">
                            <button type="button" class="btn btn-light text-muted fw-bold" style="border-radius: 10px;"
                                data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn btn-primary fw-bold px-4"
                                style="border-radius: 10px; background: #3b82f6; border:none;">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <form action="<?= BASE_URL ?>/editor/publikasi/update" method="POST">
                        <div class="modal-body pt-4">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Judul
                                        Publikasi</label>
                                    <input type="text" name="judulpublikasi" id="edit_judul"
                                        class="form-control form-control-lg fs-6" style="border-radius: 10px;" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Tahun
                                        Terbit</label>
                                    <input type="number" name="tahunterbit" id="edit_tahun"
                                        class="form-control form-control-lg fs-6" style="border-radius: 10px;" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Link
                                        Eksternal</label>
                                    <input type="url" name="linkfile" id="edit_link"
                                        class="form-control form-control-lg fs-6" style="border-radius: 10px;" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Penulis</label>
                                    <select name="penulis" id="edit_penulis" class="form-select form-select-lg fs-6"
                                        style="border-radius: 10px;">
                                        <?php if(isset($members)): foreach($members as $m): ?>
                                        <option value="<?= $m['idmember'] ?>"><?= htmlspecialchars($m['namamember']) ?>
                                        </option>
                                ...
                                <div class="col-12">
                                    <label class="form-label fw-bold text-muted small text-uppercase">Ringkasan</label>
                                    <textarea name="ringkasan" id="edit_ringkasan"
                        ...
                        <div class="modal-footer border-0 pt-0 pb-4 pe-4">
                            <button type="button" class="btn btn-light text-muted fw-bold" style="border-radius: 10px;"
                                data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn btn-primary fw-bold px-4"
                                style="border-radius: 10px; background: #3b82f6; border:none;">Update</button>
                        </div>
                    </form>
                </div>
            </div>
